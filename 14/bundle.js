...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: UserAction, UpdateType, FilterType, StatisticFilter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "StatisticFilter", function() { return StatisticFilter; });
const UserAction = {
...
/* harmony import */ var _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./presenter/movie-list.js */ "./src/presenter/movie-list.js");
/* harmony import */ var _view_movie_counter_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/movie-counter.js */ "./src/view/movie-counter.js");
...
/* harmony import */ var _presenter_statistic_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./presenter/statistic.js */ "./src/presenter/statistic.js");
...
const api = new _api_js__WEBPACK_IMPORTED_MODULE_7__["default"](END_POINT, AUTHORIZATION);
const filterModel = new _model_filter_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const statisticPresenter = new _presenter_statistic_js__WEBPACK_IMPORTED_MODULE_9__["default"](mainElement, moviesModel);
const movieListPresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_1__["default"](mainElement, bodyElement, moviesModel, filterModel, api);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(headerElement, new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](moviesModel), _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
movieListPresenter.init();
new _presenter_filter_js__WEBPACK_IMPORTED_MODULE_6__["default"](mainElement, filterModel, moviesModel, statisticPresenter, movieListPresenter).init();
api.getFilms()
  .then((films) => {
    moviesModel.setFilms(_const_js__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT, films);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_3__["render"])(footerStatisticsElement, new _view_movie_counter_js__WEBPACK_IMPORTED_MODULE_2__["default"](films.length), _utils_render_js__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].BEFOREEND);
  });
...
class Filter extends _utils_observer_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._activeFilter = _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES;
  }
...
class Film {
  ...
  init(film) {
    ...
    if (prevFilmCardElement === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._filmCardElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
    }

    this._api.getComments(film.id)
      .then((data) => {
        this._filmComments = data.slice();
        this._filmDetailElement = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_1__["default"](film, this._filmComments);
  ...
  _handleWatchListClick() {
    ...
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].UPDATE_FILM, _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR, Object.assign({}, this._film, {status}));
  }
  ...
  _handleDeleteButtonClick(commentId, callback) {
    ...
    this._changeData(_const_js__WEBPACK_IMPORTED_MODULE_4__["UserAction"].DELETE_COMMENT, _const_js__WEBPACK_IMPORTED_MODULE_4__["UpdateType"].MINOR, Object.assign({}, this._film, {comments: newComments.slice()}, {deletedIdComment: commentId}), callback);
  }
...
class Filter {
  ...
  init() {
    ...
    this._filterElement = new _view_menu_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, this._currentFilter);
    ...
    if (prevFilterElement === null) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._filterContainer, this._filterElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].AFTERBEGIN);
      return;
    }
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["replace"])(this._filterElement, prevFilterElement);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(prevFilterElement);
  }
  ...
  _getFilters() {
    ...
    return [
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].WATCHLIST,
        name: `Watchlist`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].WATCHLIST](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].HISTORY,
        name: `History`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].HISTORY](films).length
      },
      {
        type: _const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].FAVORITES,
        name: `Favorites`,
        count: _utils_filter_js__WEBPACK_IMPORTED_MODULE_3__["filter"][_const_js__WEBPACK_IMPORTED_MODULE_2__["FilterType"].FAVORITES](films).length
      }
    ];
  }
}
...
/* harmony import */ var _utils_film_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../utils/film.js */ "./src/utils/film.js");
/* harmony import */ var _film_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./film.js */ "./src/presenter/film.js");
...
/* harmony import */ var _view_loading_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../view/loading.js */ "./src/view/loading.js");
...
class MovieList {
  constructor(mainElement, bodyElement, moviesModel, filterModel, api) {
    ...
    this._loadingElement = new _view_loading_js__WEBPACK_IMPORTED_MODULE_11__["default"]();
    this._showMoreButtonElement = null;
    this._noFilmElement = new _view_no_film_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    ...
    this._currentSortType = _view_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT;
    this._filmPresenter = {};
  ...
  showFilmsContainer() {
    ...
    this._handleSortTypeChange(_view_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].DEFAULT);
  }

  _getFilms() {
    const filterType = this._filterModel.getFilter();
    const films = this._moviesModel.getFilms();
    const filteredFilms = _utils_filter_js__WEBPACK_IMPORTED_MODULE_10__["filter"][filterType](films);

    switch (this._currentSortType) {
      case _view_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].DATE:
        return filteredFilms.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_7__["sortByDate"]);
      case _view_sort_js__WEBPACK_IMPORTED_MODULE_0__["SortType"].RATING:
        return filteredFilms.sort(_utils_film_js__WEBPACK_IMPORTED_MODULE_7__["sortByRating"]);
    }
  ...
  _renderSort() {
    ...
    this._sortElement = new _view_sort_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._currentSortType);
    this._sortElement.setSortTypeChangeHandler(this._handleSortTypeChange);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._mainElement, this._sortElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderBoard() {
    ...
    this._renderSort();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._mainElement, this._filmsContainerElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmsContainerElement, this._filmsListElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmsListElement, this._filmsListContainerElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  ...
  _renderFilm(container, film) {
    const filmPresenter = new _film_js__WEBPACK_IMPORTED_MODULE_8__["default"](container, this._bodyElement, this._handleViewAction, this._handleModeChange, this._api);
    filmPresenter.init(film);
    this._filmPresenter[film.id] = filmPresenter;
  }

  _renderNoFilmElement() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmsListElement, this._noFilmElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }
  ...
  _renderShowMoreButton() {
    ...
    this._showMoreButtonElement = new _view_show_more_button_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showMoreButtonElement.setClickHandler(this._handleShowMoreButtonElementClick);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._filmsListElement, this._showMoreButtonElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }

  _renderLoading() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["render"])(this._mainElement, this._loadingElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }
  ...
  _handleShowMoreButtonElementClick() {
    ...
    if (this._renderFilmCount >= filmCount) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._showMoreButtonElement);
    }
  }

  _handleViewAction(actionType, updateType, update, callback) {
    switch (actionType) {
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UserAction"].UPDATE_FILM:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      ...
      case _const_js__WEBPACK_IMPORTED_MODULE_9__["UpdateType"].INIT:
        ...
        Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._loadingElement);
        this._renderBoard();
        break;
    }
  }
  ...
  _clearBoard({resetRenderedTaskCount = false, resetSortType = false} = {}) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._sortElement);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._noFilmElement);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._loadingElement);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._showMoreButtonElement);
...
/* harmony import */ var _view_statistic_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/statistic.js */ "./src/view/statistic.js");
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
...
class Statistic {
  constructor(container, moviesModel) {
    ...
    this._moviesModel = moviesModel;
    this._statisticFilter = _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].ALL_TIME;
  ...
  removeStatisticElement() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["remove"])(this._statisticElement);
  }
  ...
  _renderStatistic() {
    ...
    this._statisticElement = new _view_statistic_js__WEBPACK_IMPORTED_MODULE_0__["default"](this._getStatisticDataFromWatchedFilms(this._watchedFilms, this._statisticFilter), this._moviesModel);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_1__["render"])(this._container, this._statisticElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_1__["RenderPosition"].BEFOREEND);
  ...
  _setWatchedFilmsForStatistic(films, statisticFilter) {
    ...
    const dateAWeekAgo = moment__WEBPACK_IMPORTED_MODULE_2___default()().subtract(7, MomentSetting.DAYS);
    const dateAMonthAgo = moment__WEBPACK_IMPORTED_MODULE_2___default()().subtract(1, MomentSetting.MONTH);
    const dateAYearAgo = moment__WEBPACK_IMPORTED_MODULE_2___default()().subtract(1, MomentSetting.YEAR);

    switch (statisticFilter) {
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].ALL_TIME:
        this._watchedFilms = films.filter(({status}) => status.watched && status.watchingDate !== null);
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].TODAY:
        this._watchedFilms = films.filter(({status}) => status.watched && moment__WEBPACK_IMPORTED_MODULE_2___default()(status.watchingDate).isSame(currentDate, MomentSetting.DAY));
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].WEEK:
        this._watchedFilms = films.filter(({status}) => status.watched && moment__WEBPACK_IMPORTED_MODULE_2___default()(status.watchingDate).isBetween(dateAWeekAgo, currentDate));
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].MONTH:
        this._watchedFilms = films.filter(({status}) => status.watched && moment__WEBPACK_IMPORTED_MODULE_2___default()(status.watchingDate).isBetween(dateAMonthAgo, currentDate));
        break;
      case _const_js__WEBPACK_IMPORTED_MODULE_3__["StatisticFilter"].YEAR:
        this._watchedFilms = films.filter(({status}) => status.watched && moment__WEBPACK_IMPORTED_MODULE_2___default()(status.watchingDate).isBetween(dateAYearAgo, currentDate));
        break;
      default:
...
/*!*****************************!*\
  !*** ./src/utils/common.js ***!
  \*****************************/
/*! exports provided: Key, getRandomInteger, getRandomValueFromArray, getRandomDouble, generateId, getHumaniseDuration, getConvertingDate */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getHumaniseDuration", function() { return getHumaniseDuration; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getConvertingDate", function() { return getConvertingDate; });
...
const getHumaniseDuration = (minutes) => {
  const duration = moment__WEBPACK_IMPORTED_MODULE_0___default.a.duration(minutes, `minutes`);
  const format = minutes > 60 ? `H[h] mm[m]` : `mm[m]`;
  return moment__WEBPACK_IMPORTED_MODULE_0___default.a.utc(duration.as(`milliseconds`)).format(format).toString();
};
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: getRandomDate, sortByDate, sortByRating */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const filter = {
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].ALL_MOVIES]: (values) => values.slice(),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].WATCHLIST]: (values) => values.filter((element) => element.status.watchlist),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].HISTORY]: (values) => values.filter((element) => element.status.watched),
  [_const_js__WEBPACK_IMPORTED_MODULE_0__["FilterType"].FAVORITES]: (values) => values.filter((element) => element.status.favorite),
};
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, renderTemplate, render, createElement, remove, replace */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/*!***********************************!*\
  !*** ./src/utils/user-profile.js ***!
  \***********************************/
/*! exports provided: getUserStatus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const createFilmCardTemplate = (film) => {
  ...
  const genre = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getRandomValueFromArray"])(genres);
  const year = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getConvertingDate"])(releaseDate, `film card`);
...
const createFilmDetailsTemplate = (film, emoji, message, filmsComments) => {
  ...
  const humanizeDuration = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getHumaniseDuration"])(duration);
  const fullReleaseDateFilm = Object(_utils_common_js__WEBPACK_IMPORTED_MODULE_0__["getConvertingDate"])(releaseDate, `film detail`);
...
const createMenuTemplate = (filterItems, currentFilter) => {
  ...
  return `<nav class="main-navigation">
      <div class="main-navigation__items">
        <a href="#all" class="main-navigation__item ${currentFilter === _const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES ? `main-navigation__item--active` : ``}" data-filter-type="${_const_js__WEBPACK_IMPORTED_MODULE_1__["FilterType"].ALL_MOVIES}">All movies</a>
        ${menuItemsTemplate}
      </div>
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return MovieCounter; });
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");


class MovieCounter extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(count) {
    super();
    this._count = count;
  }
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const.js */ "./src/const.js");
/* harmony import */ var _utils_user_profile_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/user-profile.js */ "./src/utils/user-profile.js");
...
const renderChart = (statisticCtx, genres, counts) => {
  ...
  return new chart_js__WEBPACK_IMPORTED_MODULE_4___default.a(statisticCtx, {
...
const createStatisticTemplate = ({filter, watchedCount, totalDuration, topGenre}, userStatus) => {
  ...
  <form action="https://echo.htmlacademy.ru/" method="get" class="statistic__filters">
    ...
    <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-all-time" value="all-time" ${filter === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticFilter"].ALL_TIME ? `checked` : ``}>
    <label for="statistic-all-time" class="statistic__filters-label">All time</label>

    <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-today" value="today" ${filter === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticFilter"].TODAY ? `checked` : ``}>
    <label for="statistic-today" class="statistic__filters-label">Today</label>

    <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-week" value="week" ${filter === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticFilter"].WEEK ? `checked` : ``}>
    <label for="statistic-week" class="statistic__filters-label">Week</label>

    <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-month" value="month" ${filter === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticFilter"].MONTH ? `checked` : ``}>
    <label for="statistic-month" class="statistic__filters-label">Month</label>

    <input type="radio" class="statistic__filters-input visually-hidden" name="statistic-filter" id="statistic-year" value="year" ${filter === _const_js__WEBPACK_IMPORTED_MODULE_2__["StatisticFilter"].YEAR ? `checked` : ``}>
...
class Statistic extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    return createStatisticTemplate(this._statisticData, Object(_utils_user_profile_js__WEBPACK_IMPORTED_MODULE_3__["getUserStatus"])(this._moviesModel.getWatchedCount()));
  }
...
/* harmony import */ var _abstract_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./abstract.js */ "./src/view/abstract.js");
/* harmony import */ var _utils_user_profile_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/user-profile.js */ "./src/utils/user-profile.js");
...
class UserProfile extends _abstract_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  getTemplate() {
    return createUserProfileTemplate(Object(_utils_user_profile_js__WEBPACK_IMPORTED_MODULE_1__["getUserStatus"])(this._moviesModel.getWatchedCount()));
  }

  setUserRaiting() {
    document.querySelector(`.profile__rating`).textContent = Object(_utils_user_profile_js__WEBPACK_IMPORTED_MODULE_1__["getUserStatus"])(this._moviesModel.getWatchedCount());
  }
}
