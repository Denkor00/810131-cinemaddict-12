...
/*!**********************!*\
  !*** ./src/const.js ***!
  \**********************/
/*! exports provided: Number, BEFOREEND */
...
/* harmony import */ var _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./view/films-list-container.js */ "./src/view/films-list-container.js");
...
/* harmony import */ var _view_film_card_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./view/film-card.js */ "./src/view/film-card.js");
/* harmony import */ var _view_statistics_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./view/statistics.js */ "./src/view/statistics.js");
/* harmony import */ var _view_film_details_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./view/film-details.js */ "./src/view/film-details.js");
/* harmony import */ var _mock_film_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mock/film.js */ "./src/mock/film.js");
/* harmony import */ var _mock_user_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./mock/user.js */ "./src/mock/user.js");
...
/* harmony import */ var _const_js__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./const.js */ "./src/const.js");
...
const renderFilm = (filmsListContainerElement, film) => {
  const filmCardElement = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_9__["default"](film);
  const filmDetailElement = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_11__["default"](film);
  ...
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsListContainerElement, filmCardElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
};

// создание моков для фильма
const commonFilms = new Array(CountType.COMMON_FILMS).fill(``).map(_mock_film_js__WEBPACK_IMPORTED_MODULE_12__["generateFilm"]);
...
const filmsStatusCount = Object(_mock_menu_js__WEBPACK_IMPORTED_MODULE_14__["generateFilmsMenu"])(commonFilms);
// мок для пользователя
const user = Object(_mock_user_js__WEBPACK_IMPORTED_MODULE_13__["generateUser"])(filmsStatusCount);
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(headerElement, new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](user).getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(mainElement, new _view_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsStatusCount).getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(mainElement, new _view_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"]().getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);

const filmsContainerElement = new _view_films_container_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(mainElement, filmsContainerElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);

const filmsListElement = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsContainerElement.getElement(), filmsListElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);

const filmListTopRatedElement = new _view_films_list_top_rated_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
const filmListMostCommented = new _view_films_list_most_commented_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsContainerElement.getElement(), filmListTopRatedElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsContainerElement.getElement(), filmListMostCommented.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);

const filmsListContainerElement = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsListElement.getElement(), filmsListContainerElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
...
filmsListExtraElements.forEach((element) => {
  const filmsListContainer = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_7__["default"]();
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(element, filmsListContainer.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
...
Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(footerStatisticsElement, new _view_statistics_js__WEBPACK_IMPORTED_MODULE_10__["default"](filmsCount).getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
...
if (commonFilms.length > CountType.RENDER_FOR_STEP) {
  ...
  const showMoreButtonElement = new _view_show_more_button_js__WEBPACK_IMPORTED_MODULE_8__["default"]();
  Object(_utils_js__WEBPACK_IMPORTED_MODULE_15__["render"])(filmsListElement.getElement(), showMoreButtonElement.getElement(), _const_js__WEBPACK_IMPORTED_MODULE_16__["BEFOREEND"]);
...
const generateDesciption = (sentences) => sentences.slice(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ZERO, Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].FIVE)).join(``);
const generateGenre = (genreTypes) => genreTypes.slice(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ZERO, Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE, genreTypes.length - _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE));

const generateDuration = () => ({
  hours: Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ZERO, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE),
  minutes: Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].SIXTY),
});

const getRandomBooleanValue = () => Boolean(Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ZERO, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE));
...
const generateFilm = () => {
  return {
    ...
    rating: Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomDouble"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ONE, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].NINE),
    ...
    comments: new Array(Object(_utils_js__WEBPACK_IMPORTED_MODULE_1__["getRandomInteger"])(_const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].ZERO, _const_js__WEBPACK_IMPORTED_MODULE_2__["Number"].FIVE)).fill(``).map(_comment_js__WEBPACK_IMPORTED_MODULE_0__["generateComment"]),
    ageRating: `18+`,
...
const createFilmCardTemplate = (film) => {
  ...
  const year = releaseDate.slice(releaseDate.length - _const_js__WEBPACK_IMPORTED_MODULE_1__["Number"].FOUR, releaseDate.length);
...
const createFilmDetailsTemplate = (film) => {
  ...
  const genreFieldName = genres.length > _const_js__WEBPACK_IMPORTED_MODULE_1__["Number"].ONE ? `Genres` : `Genre`;
