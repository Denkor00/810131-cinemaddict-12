...
/* harmony import */ var _view_statistics_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./view/statistics.js */ "./src/view/statistics.js");
/* harmony import */ var _mock_film_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mock/film.js */ "./src/mock/film.js");
/* harmony import */ var _mock_user_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./mock/user.js */ "./src/mock/user.js");
/* harmony import */ var _mock_menu_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./mock/menu.js */ "./src/mock/menu.js");
...
const commonFilms = new Array(COMMON_FILMS_COUNT).fill(``).map(_mock_film_js__WEBPACK_IMPORTED_MODULE_5__["generateFilm"]);
const filmsCount = commonFilms.length;
// счет фильмов для меню, для статуса пользователя
const filmsStatusCount = Object(_mock_menu_js__WEBPACK_IMPORTED_MODULE_7__["generateFilmsMenu"])(commonFilms);
// мок для пользователя
const user = Object(_mock_user_js__WEBPACK_IMPORTED_MODULE_6__["generateUser"])(filmsStatusCount);

const headerElement = document.querySelector(`.header`);
const mainElement = document.querySelector(`.main`);
const footerStatisticsElement = document.querySelector(`.footer__statistics`);

Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(headerElement, new _view_user_profile_js__WEBPACK_IMPORTED_MODULE_0__["default"](user), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["BEFOREEND"]);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(mainElement, new _view_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"](filmsStatusCount), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["BEFOREEND"]);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(mainElement, new _view_sort_js__WEBPACK_IMPORTED_MODULE_2__["default"](), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["BEFOREEND"]);
Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_8__["render"])(footerStatisticsElement, new _view_statistics_js__WEBPACK_IMPORTED_MODULE_4__["default"](filmsCount), _utils_render_js__WEBPACK_IMPORTED_MODULE_8__["BEFOREEND"]);

// презентер
const moviePresenter = new _presenter_movie_list_js__WEBPACK_IMPORTED_MODULE_3__["default"](mainElement);
...
/* harmony import */ var _view_films_container_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/films-container.js */ "./src/view/films-container.js");
/* harmony import */ var _view_films_list_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/films-list.js */ "./src/view/films-list.js");
/* harmony import */ var _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../view/films-list-container.js */ "./src/view/films-list-container.js");
/* harmony import */ var _view_films_list_top_rated_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../view/films-list-top-rated.js */ "./src/view/films-list-top-rated.js");
/* harmony import */ var _view_films_list_most_commented_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/films-list-most-commented.js */ "./src/view/films-list-most-commented.js");
...
class MovieList {
  constructor(mainElement) {
    ...
    this._filmsContainerElement = new _view_films_container_js__WEBPACK_IMPORTED_MODULE_0__["default"](); // главный контейнер для фильмов
    this._filmsListElement = new _view_films_list_js__WEBPACK_IMPORTED_MODULE_1__["default"](); // первый внут. контейнер для всех фильмов
    this._filmsListContainerElement = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_2__["default"](); // второй внут. контейнер для фильмов, в нем распорожены фильмы
    this._filmListTopRatedElement = new _view_films_list_top_rated_js__WEBPACK_IMPORTED_MODULE_3__["default"]();
    this._filmListMostCommentedElement = new _view_films_list_most_commented_js__WEBPACK_IMPORTED_MODULE_4__["default"]();
    this._showMoreButtonElement = new _view_show_more_button_js__WEBPACK_IMPORTED_MODULE_5__["default"]();
    this._noFilmElement = new _view_no_film_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
  ...
  init(films) {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._mainElement, this._filmsContainerElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._filmsContainerElement, this._filmsListElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
    if (!films.length) {
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._filmsListElement, this._filmsListContainerElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
  ...
  _renderExtraBoard(extraBoardContainer, films) {
    const filmListContainerElement = new _view_films_list_container_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._filmsContainerElement, extraBoardContainer, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(extraBoardContainer, filmListContainerElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
  ...
  _renderFilm(container, film) {
    const filmCardElement = new _view_film_card_js__WEBPACK_IMPORTED_MODULE_7__["default"](film);
    const filmDetailElement = new _view_film_details_js__WEBPACK_IMPORTED_MODULE_8__["default"](film);
    ...
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(container, filmCardElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
  }

  _renderNoFilmElement() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._filmsListElement, this._noFilmElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
  }

  _renderShowMoreButton() {
    Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["render"])(this._filmsListElement, this._showMoreButtonElement, _utils_render_js__WEBPACK_IMPORTED_MODULE_9__["BEFOREEND"]);
  ...
  _handleShomMoreButtonElementClick() {
    ...
    if (this._renderFilmCount >= this._films.length) {
      Object(_utils_render_js__WEBPACK_IMPORTED_MODULE_9__["remove"])(this._showMoreButtonElement);
    }
  }
}
...
/*!***************************!*\
  !*** ./src/utils/film.js ***!
  \***************************/
/*! exports provided: getRandomDate, getHumanizeViewFromDuration */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
